    ...
    <div className="grid grid-cols-3 items-center px-2 min-h-[80px]">
      ...
      <div className="w-full flex items-center justify-end gap-x-2">
        <div className="max-w-[120px] md:max-w-[160px]">
          <p className="text-sm font-bold text-slate-700 text-right truncate" title={data?.homeTeam?.name}>
            {data?.homeTeam?.name}
          </p>
        </div>
        <div className="w-[40px] h-[40px] min-w-[40px] relative bg-white/5 rounded-full p-1 shadow-sm flex justify-center items-center">
          <Image
      ...
      {/* Placar/Horário */}
      <div className="m-auto px-3 py-1.5 flex justify-center items-center gradient-bg rounded-md shadow-md text-center min-w-[60px]">
      ...
      <div className="w-full flex items-center justify-start gap-x-2">
        ...
        <div className="max-w-[120px] md:max-w-[160px]">
          <p className="text-sm font-bold text-slate-700 text-left truncate" title={data?.awayTeam?.name}>
            {data?.awayTeam?.name}
          </p>
        </div>
      </div>
