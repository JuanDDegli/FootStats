      ...
      <ul className="space-y-4 ">
        {
          leagues.map((league) => (
            <div 
            key={league.id} 
            className="flex text-slate-700 items-center cursor-pointer font-bold rounded-md transition duration-300 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-500 hover:text-white hover:scale-125"
          >
